...
class BananaApp(Application):
    ...
    color       = 0.8, 0.8, 0.2, 0.3   # model color (overlay)
    # color       = 0.8, 0.8, 0.2, 0.5   # model color (overlay)
    position    = 0.0, 0.0, 0.0        # model position
    orientation = 0.0, 0.0, 0.0        # model orientation (degrees)
    ...
    def __init__(self):
        ...
        self.set_perspective_projection(self.fov, 0.10, 1.0)          # use perspective projection for rendering
